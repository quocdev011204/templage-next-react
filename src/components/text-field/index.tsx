...
const TextFieldStyled = styled(TextField)<TextFieldProps>(({theme}) => {
  // TextFieldStyled là một component được tạo ra từ TextField và sử dụng styled-components để thêm các kiểu CSS tùy chỉnh
  // <TextFieldProps>: Kiểu của các thuộc tính mà TextFieldStyled nhận vào.
  // ({ theme }): Hàm callback nhận vào đối tượng theme từ Material-UI, cho phép truy cập các giá trị chủ đề như màu sắc, khoảng cách, và kiểu chữ.
