  ...
  return (
      <Box sx={
        ...
        <Box 
          ...
          <Image src={theme.palette.mode === 'light' ? LoginLight : LoginDark} alt='login image light' style={ { height: '100%', width: 'auto'} }/>
        </Box>
        <Box sx={ {
          display: 'flex',
          alignItems: 'center',
            ...
            <form onSubmit={handleSubmit(onSubmit)} autoComplete='off' noValidate>
              ...
              <Box sx={ { display: 'flex', alignItems: 'center', justifyContent: 'space-between'} }>
                <Typography>{"Don't have an account?"}</Typography>    
                  <Link href="/register" style={ {color: theme.palette.mode === 'light' ? theme.palette.customColors.light : theme.palette.customColors.dark} }>
                    {"Register"}
                  </Link>
              </Box>
