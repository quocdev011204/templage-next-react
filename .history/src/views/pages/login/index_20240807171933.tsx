...
const LoginPage: NextPage<TProps> = () => {
  ...
  return (
      <Box sx={
        ...
        <Box sx={ { display: "flex", alignItems: "center", justifyContent: "center", backgroundColor : theme.palette.customColors.bodyBg,height:"100%", borderRadius: '20px', minWidth: '50vw'} }>
          <Image src={LoginLight} alt='login image light' style={ { height: '100%', width: 'auto'} }/>
        </Box>
        <Box sx={ {
          display: 'flex',
          alignItems: 'center',
