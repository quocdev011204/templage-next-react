...
const RegisterPage: NextPage<TProps> = () => {
  ...
  const schema = yup.object().shape(({
    ...
    confirmPassword: yup.string().required("The field is required").matches(PASSWORD_REG, "The field is must password type").oneOf([yup.ref('password'), ''], 'Confirm password must matches with password' )
  }))
  ...
  return (
      <Box sx={
        ...
        <Box 
          ...
          <Image src={theme.palette.mode === 'light' ? RegisterLight : RegisterDark} alt='login image light' style={ { height: '100%', width: 'auto'} }/>
        </Box>
        <Box sx={ {
          display: 'flex',
          alignItems: 'center',
          ...
          >
            ...
            <form onSubmit={handleSubmit(onSubmit)} autoComplete='off' noValidate>
              ...
              <Box sx={ {display: 'flex', alignItems: 'center', justifyContent: 'center', gap: '10px'} }>
                <IconButton sx={ { color: theme.palette.mode === 'light' ? theme.palette.customColors.light : theme.palette.customColors.dark} }>
